...
//Last modified: Thu, Sep 12, 2024 10:53:04 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "D5D0140D-4F72-0DB3-85EB-49A75EFAA764";
createNode transform -s -n "persp";
	rename -uid "D79D86A0-4B3F-A8BE-27DA-EDBF3C8FB152";
	setAttr ".t" -type "double3" 1.2249564324039786 5.1026963821210556 7.9568334843512138 ;
	setAttr ".r" -type "double3" 2139.2616472593304 -1059.7999999998804 4.2362524338670896e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "83C1F093-417C-2E1F-CA42-F68AD8E4E3D6";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 9.896229563728232;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "066A2669-4399-3FF6-AAF7-12ADA5512443";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "2FF5A7A7-460D-6977-4416-70AB6E4BC38F";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "97F5E473-42BB-E75B-4B1E-53A5C8E7F4F9";
createNode displayLayerManager -n "layerManager";
	rename -uid "8152CC90-4F6A-150B-8F5E-57A217A51441";
createNode displayLayer -n "defaultLayer";
	rename -uid "ADB0A2AF-4258-6095-E0F8-898E32100801";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "58501A00-4104-B282-8582-90ACE4A05BD1";
...
createNode polyTweak -n "polyTweak6";
	...
	setAttr ".uopa" yes;
	setAttr -s 14 ".tk";
	setAttr ".tk[8]" -type "float3" -0.124241 -2.220446e-16 0 ;
	setAttr ".tk[9]" -type "float3" 0.11842784 0 3.7107384e-09 ;
	setAttr ".tk[10]" -type "float3" -0.12259723 2.220446e-16 -3.7252903e-09 ;
	setAttr ".tk[11]" -type "float3" 0.13085057 2.220446e-16 0 ;
	setAttr ".tk[12]" -type "float3" -1.1175871e-08 -2.220446e-16 0.077448323 ;
	setAttr ".tk[13]" -type "float3" -3.7252903e-09 2.220446e-16 -0.077134907 ;
	setAttr ".tk[14]" -type "float3" 3.7252903e-09 2.220446e-16 0.074453108 ;
	setAttr ".tk[15]" -type "float3" -1.1175871e-08 2.220446e-16 -0.075338222 ;
	setAttr ".tk[16]" -type "float3" 0.031516057 6.5493904e-09 0.11351755 ;
	setAttr ".tk[17]" -type "float3" -0.079385459 6.5493904e-09 0.11423834 ;
	setAttr ".tk[18]" -type "float3" -0.065490283 -6.549393e-09 -0.049334802 ;
	setAttr ".tk[19]" -type "float3" 0.022168592 6.5493904e-09 -0.05078027 ;
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "F0BC6C25-4625-036E-DEE7-B49D27F6DD01";
