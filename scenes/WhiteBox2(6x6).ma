...
//Last modified: Thu, Sep 12, 2024 11:30:04 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "117E7386-4FA9-6027-EAE0-7293AD9418D7";
createNode transform -s -n "persp";
	rename -uid "D79D86A0-4B3F-A8BE-27DA-EDBF3C8FB152";
	setAttr ".t" -type "double3" 12.588254050170342 6.3617668742310034 16.662633900260563 ;
	setAttr ".r" -type "double3" 2146.4616472592784 -1050.1999999998393 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "83C1F093-417C-2E1F-CA42-F68AD8E4E3D6";
	setAttr -k off ".v";
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 21.775006338502102;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "9F0DA7C3-4451-268D-853B-E5A401B76FB1";
	setAttr -s 5 ".lnk";
	setAttr -s 5 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "AD400161-461C-B8A7-AC39-B2BE2423D99D";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "5EF75915-471C-6598-73EF-3494380574B8";
createNode displayLayerManager -n "layerManager";
	rename -uid "BB13574F-4016-6DEC-E8D2-36841BE04E0F";
createNode displayLayer -n "defaultLayer";
	rename -uid "ADB0A2AF-4258-6095-E0F8-898E32100801";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "ED00F25B-4432-0C5E-8052-C39CBB41BC6C";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "EA1CFD3A-43FE-C85E-1547-199940445F9F";
